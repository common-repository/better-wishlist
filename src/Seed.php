		...
		if ( get_option( 'bw_settings' ) === false ) {
			update_option(
				...
				[
					...
					'add_to_wishlist_text'             => __( 'Add to wishlist', 'better-wishlist' ),
					'added_to_wishlist_text'           => __( 'Added to wishlist', 'better-wishlist' ),
					'add_to_cart_text'                 => __( 'Add to cart', 'better-wishlist' ),
					'add_all_to_cart_text'             => __( 'Add all to cart', 'better-wishlist' ),
					'no_product_added_text'            => __( 'No Product Added', 'better-wishlist' ),
					...
					'wishlist_table_image_text'        => __( 'Image', 'better-wishlist' ),
					'wishlist_table_name_text'         => __( 'Product Name', 'better-wishlist' ),
					'wishlist_table_stock_text'        => __( 'Stock Status', 'better-wishlist' ),
					'wishlist_table_price_text'        => __( 'Price', 'better-wishlist' ),
					'wishlist_table_add_to_cart_text'  => __( 'Add to cart', 'better-wishlist' ),
					...
					'cart_button_font_style'           => 'default',
